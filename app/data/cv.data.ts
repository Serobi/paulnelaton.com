      ...
      experience: [
        {
          ...
          desc: [
            ...
            "Réalisation de tests unitaires et d'intégration pour assurer la fiabilité et la qualité des développements.",
            "Optimisation des traitements et requêtes SQL sur SQL Server et DB2 pour améliorer les performances et la maintenabilité.",
          ],
        },
        {
          period: "05/2024 - 04/2026",
        ...
        },
        {
          period: "09/2021 - 04/2024",
          company: "Formation continue",
          role: "Développement Web & Frameworks modernes",
          desc: [
            "Formation en développement logiciel et technologies web modernes.",
            "JavaScript / TypeScript, React, Node.js et des architectures web.",
            "Conception, développement de projets et mise en pratique des technologies étudiées.",
            "Travail continu sur l'UI/UX, le responsive design et la conception de produits numériques.",
          ],
        },
        {
          period: "11/2019 - 06/2021",
      ...
      experience: [
        {
          ...
          desc: [
            ...
            "Implementation of unit and integration tests to ensure software reliability and quality.",
